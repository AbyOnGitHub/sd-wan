...
-	Link availability
* Run both client.py and server.py on different machines connected to the same network for simulation. Share the encryption code generated by the Server with the Client to proceed with packet transfer
